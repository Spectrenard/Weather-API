...
var API_KEY = "063ee39dffd16303bcd60731f98d6b26";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("Erreur HTTP ! Statut : ".concat(response.status));
                    }
                    return [4 /*yield*/, response.json()];
                case 3:
                    data = _a.sent();
                    console.log(data);
                    resultContainer.innerHTML = "\n      <p>M\u00E9t\u00E9o \u00E0 ".concat(data.name, " :</p>\n      <p>").concat(data.weather[0].description, "</p>\n      <p>Temp\u00E9rature : ").concat(data.main.temp, "\u00B0C</p>\n      <p>Humidit\u00E9 : ").concat(data.main.humidity, "%</p>\n      <p>Vitesse du vent : ").concat(data.wind.speed, " m/s</p>\n    ");
                    return [3 /*break*/, 6];
                case 4:
                    error_1 = _a.sent();
                    console.error("Erreur lors de la récupération des données:", error_1);
                    resultContainer.innerHTML = "<p class=\"error\">Erreur: ".concat(error_1.message, "</p>");
                    return [3 /*break*/, 6];
                case 5:
...
button.addEventListener("click", function () {
    var city = valueInput.value.trim(); // Récupérer la valeur de l'input et enlever les espaces
    if (city) {
